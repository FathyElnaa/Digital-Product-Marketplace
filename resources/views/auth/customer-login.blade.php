            ...
            <div class="account account--login mt-5 pt-5">
                ...
                <div class="account__login w-100">
                    <form class="mb-5" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="input-group rounded-1 mb-3">
                            <input type="text" class="form-control p-3" placeholder="البريد الالكتروني"
                ...
                <div class="account__register w-100">
                    <form class="mb-5" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group rounded-1 mb-3">
                            <input type="text" class="form-control p-3" placeholder="البريد الالكتروني" name="email"
                        ...
                        <div class="input-group rounded-1 mb-3">
                            <input type="password" class="form-control p-3" placeholder="كلمة السر" name="password"
                                aria-label="Password" aria-describedby="basic-addon1" />
                            <span class="input-group-text login__input-icon" id="basic-addon1">
                                <i class="fa-solid fa-key"></i>
                            </span>
                        ...
                        <div class="input-group rounded-1 mb-3">
                            <input type="password" class="form-control p-3" placeholder="تاكيد كلمة السر"
